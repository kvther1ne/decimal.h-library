...
START_TEST(test_s21_is_greater_or_equal_equally) {
  int status;
  s21_decimal a, b;
  create_decimal_from_arr(&a, 1U, 0U, 555U, 2U, 1U);
  create_decimal_from_arr(&b, 1U, 0U, 555U, 2U, 1U);
  status = s21_is_greater_or_equal(a, b);
  ck_assert(status == TRUE);
}
END_TEST

START_TEST(test_s21_is_greater_or_equal_equally2) {
  int status;
  s21_decimal a, b;
...
START_TEST(test_s21_is_greater_or_equal_equally3) {
  int status;
  s21_decimal a, b;
...
START_TEST(test_s21_is_greater_or_equal_more) {
  int status;
  s21_decimal a, b;
  // 12345.7890
...
START_TEST(test_s21_is_greater_or_equal_more2) {
  int status;
  s21_decimal a, b;
  // -55555.111
...
START_TEST(test_s21_is_greater_or_equal_more3) {
  int status;
  s21_decimal a, b;
  // 123.456
...
START_TEST(test_s21_is_greater_or_equal_less2) {
  int status;
  s21_decimal a, b;
...
START_TEST(test_s21_is_greater_or_equal_less3) {
  int status;
  s21_decimal a, b;
...
Suite *test_greater_or_equal() {
  ...
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_equally);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_equally2);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_equally3);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_more);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_more2);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_more3);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_less);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_less2);
  tcase_add_test(tc_core, test_s21_is_greater_or_equal_less3);
