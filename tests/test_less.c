...
START_TEST(test_s21_is_less_equally3) {
  int status;
  s21_decimal a, b;
...
START_TEST(test_s21_is_less_more) {
  int status;
  s21_decimal a, b;
  // 12345.7890
...
START_TEST(test_s21_is_less_more2) {
  int status;
  s21_decimal a, b;
  // -55555.111
...
START_TEST(test_s21_is_less_more3) {
  int status;
  s21_decimal a, b;
  // 123.456
...
START_TEST(test_s21_is_less_less) {
  int status;
  s21_decimal a, b;
  // -1234567890.555
...
START_TEST(test_s21_is_less_less2) {
  int status;
  s21_decimal a, b;
...
START_TEST(test_s21_is_less_less3) {
  int status;
  s21_decimal a, b;
...
Suite *test_less() {
  ...
  tcase_add_test(tc_core, test_s21_is_less_equally);
  tcase_add_test(tc_core, test_s21_is_less_equally2);
  tcase_add_test(tc_core, test_s21_is_less_equally3);
  tcase_add_test(tc_core, test_s21_is_less_more);
  tcase_add_test(tc_core, test_s21_is_less_more2);
  tcase_add_test(tc_core, test_s21_is_less_more3);
  tcase_add_test(tc_core, test_s21_is_less_less);
  tcase_add_test(tc_core, test_s21_is_less_less2);
  tcase_add_test(tc_core, test_s21_is_less_less3);
